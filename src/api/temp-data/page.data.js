  ...
  about: {
    ...
    skills: {
      ...
      items: [
        ...
        { name: 'webpack.', detail: "I have a love-hate relationship with Webpack. Our Angular project currently runs with a custom config (what?! - no CLI!?) of which I have become the owner. It was a struggle to wrap my head around, but now I find it fun to work with.", use: 'production' },
        ...
        { name: 'node.', detail: "As a backend technology, I've used node to build out the api and serve up my front end code. You could also say I've used it in production given it's deep integration with the front end workflow.", use: 'hobby project' },
        { name: 'mongodb.', detail: "When I've had to integrate a db for a project, I've gone to mongo with the mongoose node package.", use: 'hobby project' },
        { name: 'express.', detail: "It's the standard when it comes to building a rest api in node and, as such, has been one I've used in my projects.", use: 'hobby project' },
        ...
        { name: 'git.', detail: "Basic stuff - git add, git commit, git push - I've used this to manage my personal projects and keep them in sync through bitbucket.", use: 'hobby project' },
        { name: 'bitbucket.', detail: "Where I manage my personal projects.", use: 'hobby project' },
        { name: 'react.', detail: "I have built some smaller apps with React and really enjoyed it. It was the first front end framework that I used for a project.", use: 'hobby project' },
        { name: 'vue.', detail: "This is the framework behind my current website (the one you're looking at). It's really enjoyable - both for simple projects and extendable for more complex ones.", use: 'hobby project' },
        { name: 'linux.', detail: "My OS of choice - Ubuntu flavors, mostly. Currently, I use elementaryOS on my personal dev box.", use: 'hobby project' },
        { name: 'unix.', detail: "macOS - this is where I learned to develop.", use: 'hobby project' },
        { name: 'figma.', detail: "When I'm just starting a project, Figma is my current go-to for laying out interfaces. Before this is was Sketch and Photoshop/Illustrator. Figma's great since it's a webapp.", use: 'hobby project' },
        { name: 'sketch.', detail: "Prior to Figma, I used Sketch. They are very similar. I have found Figma to be more universal across operating systems and thus helpful in my os hopping.", use: 'hobby project' },
